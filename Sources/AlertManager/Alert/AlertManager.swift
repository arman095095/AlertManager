...
public protocol AlertManagerProtocol {
    func present(type: InfoType, title: String)
}
...
public final class AlertManager: AlertManagerProtocol {
    ...
    public func present(type: InfoType, title: String = "") {
...
private extension AlertManager {
    ...
    func attributes(type: InfoType) -> EKAttributes {
    ...
    private final class InfoAlertView: UIView {
        ...
        init(title: String, type: InfoType) {
            self.type = type
